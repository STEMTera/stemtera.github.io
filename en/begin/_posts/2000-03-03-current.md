...
card-image: current_electrons_flow.svg
lang: en
description: What is current? Despite current is the flow of electrons (negative) through a conducting medium to positive charged atoms, current flow is often or normally defined as conventional current, where it flows from positive terminal to the negative. In this guide, we will be referencing conventional current as current.
