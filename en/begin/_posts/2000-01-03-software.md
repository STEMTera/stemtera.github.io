...
Click and download the appropriate Operating Sytem installation package for your computer. As soon as the download is completed, if you are familiar with installing software, please proceed with the installation, otherwise open up your browser and type in the following URL into the browser's address bar to read SparkFun's Installing Arduino IDE guide.
