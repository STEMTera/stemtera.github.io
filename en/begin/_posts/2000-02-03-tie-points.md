...
![(STMB) clip](img/stemtera_breadboard_clip.svg){: .quarter-h-h .left }Inside the holes of the tie points are spring clips. These spring clips are in the formation of 1x2, 1x5 and 1x30. When you insert a component, a resistor for example, inside a tie point, the leg of the resistor will be held by the two arms of the clip inside the tie point, thus making a mechanical connection as shown on the left diagram. Because the clips are made from copper or stainless steel, electricity can flow from the resistor to the clip.
